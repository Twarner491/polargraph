...
function generateGcodeForEntities(entities, colorId = null) {
    ...
    const settings = {
        ...
        feed_rate_travel: parseFloat(document.getElementById('feedTravel')?.value) || 600,
        feed_rate_draw: parseFloat(document.getElementById('feedDraw')?.value) || 300,
...
function applySettingsToUI(settings) {
    ...
    document.getElementById('feedTravel').value = settings.feed_rate_travel || 600;
    document.getElementById('feedDraw').value = settings.feed_rate_draw || 300;
