...
GENERATORS = {
    ...
    14: {'id': 'slimemold', 'name': 'Slime Mold', 'options': ['agents (100-10000)', 'iterations (50-1000)', 'sensor_angle (10-90)', 'sensor_distance (3-30)', 'turn_angle (10-90)']},
    15: {'id': 'geodataweaving', 'name': 'Geodata Weaving', 'options': ['latitude (-90 to 90)', 'longitude (-180 to 180)', 'threads (16-128)', 'shafts (2-8)']},
    16: {'id': 'poetryclouds', 'name': 'Poetry Clouds', 'options': ['text_size (3-20mm)', 'cloud_threshold (0.3-0.7)', 'noise_scale (0.005-0.05)', 'seed (-1 for random)', 'custom_text (optional)']},
    17: {'id': 'geometricpattern', 'name': 'Geometric Pattern', 'options': ['columns (2-8)', 'rows (2-10)', 'seed (-1 for random)']},
    18: {'id': 'glow', 'name': 'Glow (Multi-Color)', 'options': ['color_profile (rainbow/warm/cool/monochrome/primary/pastel)', 'particles (100-2000)', 'iterations (50-500)', 'noise_scale (0.005-0.05)', 'seed (-1 for random)']},
    19: {'id': 'randompoetry', 'name': 'Random Poetry', 'options': ['word_source (dickinson/shakespeare/poe/whitman/romantic/nature/cosmic/gothic/zen)', 'word_count (5-50)', 'min_size (10-30mm)', 'max_size (20-60mm)', 'seed (-1 for random)']},
    20: {'id': 'gameoflife', 'name': 'Game of Life', 'options': ['cell_size (5-30mm)', 'generations (10-200)', 'initial_density (0.2-0.6)', 'seed (-1 for random)', 'draw_grid (true/false)']},
    21: {'id': 'zenpots', 'name': 'Zen Pots (Multi-Color)', 'options': ['pot_count (3-20)', 'pot_color (terracotta/earth/slate/clay/ceramic/rustic/modern/vintage)', 'flower_style (branches/minimal/full/mixed/none)', 'flower_color (forest/spring/autumn/lavender/wildflower/tropical/berry/ink)', 'seed (-1 for random)']},
    22: {'id': 'bezier', 'name': 'Bezier Curves', 'options': ['curve_count (5-50)', 'curve_spread (20-200)', 'style (flowing/random/parallel/radial/wave)', 'seed (-1 for random)']},
    23: {'id': 'noise', 'name': 'Perlin Noise Dots', 'options': ['grid_spacing (5-30mm)', 'noise_scale_x (0.005-0.05)', 'noise_scale_y (0.005-0.05)', 'shape (circle/square/diamond/cross/line)', 'seed (-1 for random)']},
    24: {'id': 'kaleidoscope', 'name': 'Kaleidoscope', 'options': ['symmetry (4-16)', 'pattern (curves/lines/spirals/petals/geometric)', 'complexity (5-20)', 'seed (-1 for random)']},
    25: {'id': 'colorfuldots', 'name': 'Colorful Dots (CMYK Multi-Color)', 'options': ['color_mode (cmyk/rgb/primary/warm/cool)', 'grid_spacing (10-30mm)', 'max_dot_size (8-20mm)', 'num_circles (10-50)', 'seed (-1 for random)']},
    26: {'id': 'interlockings', 'name': 'Interlockings (Multi-Color)', 'options': ['num_layers (4-12)', 'lines_per_layer (20-60)', 'line_spacing (3-10mm)', 'seed (-1 for random)']},
    27: {'id': 'sudokucartography', 'name': 'Sudoku Cartography', 'options': ['initial_clues (15-25)', 'curve_tension (30-100)', 'draw_grid (true/false)', 'seed (-1 for random)']},
}
